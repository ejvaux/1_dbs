<div class='row'>
    <div class='col-md'>
        <ul class="nav flex-column sidebar-wrapper pt-2 px-4">
            ...
            <li class="nav-item my-2">
                <a class="nav-link sblink" href="{{ route('master') }}"><i class="fas fa-box mr-3 sbicon"></i>MASTERLIST</a>
            </li>
            <li class="nav-item my-2">
                <a class="nav-link sblink" href="{{ route('incoming') }}"><i class="fas fa-sign-in-alt mr-3 sbicon"></i>INCOMING</a>
            </li>
            <li class="nav-item my-2">
