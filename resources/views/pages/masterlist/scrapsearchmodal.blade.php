<div class="modal hide fade in" role="dialog" id="scrapdanplasearchmod" data-keyboard="true" data-backdrop="static" >
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title">Search Scrap Danpla Data</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <form id="scrapdanplasearchform"  method="GET" action='{{ url('/master/advance/scrap') }}'>
            @csrf
